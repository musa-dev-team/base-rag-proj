...
from src.utils.utils import extract_urls_from_output
...
PROMPTS["DEFAULT_ENTITY_TYPES"] = config['ENTITIES']
...
def insert(rag: LightRAG, content: Union[DuckieDoc, DuckieThread, DuckieTicket]):
    rag.insert("CONTENT:"+ content.__dict__['content']+ "\n\n"+ "URL:" + content.__dict__['url'])
...
parallel_insert(content, rag, max_workers=9)
