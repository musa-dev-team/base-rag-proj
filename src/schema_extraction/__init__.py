...
from src.llm.llm_model_helper import get_model
from src.schema_extraction.constants import MODEL_VERSIONS
from langchain_core.prompts import ChatPromptTemplate
from src.schema_extraction.llm import get_llm
...
def schema_extraction_from_text(input_text:str, model:str, is_schema_description_checked:bool = True)->Schema:
